...
export const strings = {
  zh: {
    ...
    navStarred: '收藏',
    navCloud: '云端项目',
    cloudSubtitle: '在网页端用 AI 助手 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 ,请检查网络或代理设置',
    ...
    setAiByokNote:
      '对话使用你自己的 key；生图与媒体解析按「生图与媒体」设置；网页搜索仍走  登录或免费来源。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
    ...
    onbStarHint: '如果你喜欢 UToOffice，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 UToOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'UToOffice 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
  ...
  en: {
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Projects created on the web with AI 助手. Editing continues in your browser — click any project to open it.',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach  — check your network or proxy settings',
    ...
    setAiHint: 'Uses your  sign-in; no API key needed.',
    ...
    setAiByokNote:
      'Chats use your own key. Image generation and media analysis follow the AI Media section; web search still uses the  sign-in or free sources.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
    ...
    setAiMediaHint: 'Image generation and image/video analysis use your  sign-in.',
    setAiImageModel: 'Image model',
    setAiAnalysisModel: 'Analysis model',
    setAiSearchHint:
      'Web and image search use your  sign-in; signed out or with cloud tools off they fall back to free sources.',
    ...
    starPromptBody:
      'UToOffice is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like UToOffice, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to UToOffice',
    ...
    onbBody2:
      'UToOffice is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',
  ...
  ja: {
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Web で AI 助手 を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    setAiHint: ' アカウントでサインインするため、API キーは不要です。',
    ...
    setAiByokNote:
      'チャットは自分のキーを使用します。画像生成とメディア解析は「AI メディア」の設定に従い、Web 検索は引き続き  のサインインまたは無料ソースを使用します。',
    setAiSave: '保存',
    setAiSaved: '保存しました',
    setAiTest: '接続テスト',
    setAiTesting: 'テスト中…',
    ...
    setAiMediaHint: '画像生成と画像/動画解析は  のサインインを使用します。',
    setAiImageModel: '画像モデル',
    setAiAnalysisModel: '解析モデル',
    setAiSearchHint:
      'Web 検索と画像検索は  のサインインを使用します。サインアウト時やクラウドツールがオフのときは無料ソースにフォールバックします。',
    ...
    starPromptBody:
      'UToOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'UToOffice が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'UToOffice へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'UToOffice はまだアルファ版です。GenTeam のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+  クレジット**',
    ...
    onbNote3: 'AI 機能は  クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'AI 助手로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    loginCopied: '복사됨',
    loginNetworkError: '에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    setAiHint: ' 로그인으로 사용하며 API 키가 필요 없습니다.',
    ...
    setAiByokNote:
      '채팅은 내 키를 사용합니다. 이미지 생성과 미디어 분석은 「AI 미디어」 설정을 따르며, 웹 검색은 여전히  로그인 또는 무료 소스를 사용합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
    ...
    setAiMediaHint: '이미지 생성과 이미지/동영상 분석은  로그인을 사용합니다.',
    setAiImageModel: '이미지 모델',
    setAiAnalysisModel: '분석 모델',
    setAiSearchHint:
      '웹 검색과 이미지 검색은  로그인을 사용합니다. 로그아웃 상태거나 클라우드 도구가 꺼져 있으면 무료 소스로 대체됩니다.',
    ...
    starPromptBody:
      'UToOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'UToOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'UToOffice에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'UToOffice는 아직 알파 단계입니다. GenTeam 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+  크레딧**',
    ...
    onbNote3: 'AI 기능은  크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      "Projets créés sur le web avec AI 助手. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    setAiHint: 'Utilise votre connexion  ; aucune clé API requise.',
    ...
    setAiByokNote:
      "Les conversations utilisent votre propre clé. La génération d'images et l'analyse de médias suivent la section « Médias IA » ; la recherche web utilise toujours la connexion  ou des sources gratuites.",
    ...
    setAiMediaHint:
      "La génération d'images et l'analyse d'images/vidéos utilisent votre connexion .",
    setAiImageModel: "Modèle d'image",
    setAiAnalysisModel: "Modèle d'analyse",
    setAiSearchHint:
      "La recherche web et d'images utilise votre connexion  ; déconnecté ou avec les outils cloud désactivés, elle se rabat sur des sources gratuites.",
    ...
    starPromptBody:
      'UToOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si UToOffice vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans UToOffice',
    ...
    onbBody2:
      'UToOffice est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits **',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits .',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Mit AI 助手 im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    setAiHint: 'Nutzt Ihre -Anmeldung; kein API-Schlüssel nötig.',
    ...
    setAiByokNote:
      'Chats nutzen deinen eigenen Schlüssel. Bildgenerierung und Medienanalyse folgen dem Abschnitt „KI-Medien“; die Websuche nutzt weiterhin die -Anmeldung oder kostenlose Quellen.',
    setAiSave: 'Speichern',
    ...
    setAiSearchHint:
      'Web- und Bildsuche nutzen deine -Anmeldung; abgemeldet oder mit ausgeschalteten Cloud-Tools greifen sie auf kostenlose Quellen zurück.',
    ...
    starPromptBody:
      'UToOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen UToOffice gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei UToOffice',
    ...
    onbBody2:
      'UToOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ -Guthaben**',
    ...
    onbNote3: 'KI-Funktionen können -Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Proyectos creados en la web con AI 助手. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    login: 'Iniciar sesión con ',
    loggedIn: 'Sesión iniciada',
    loggedIn: 'Sesión iniciada en ',
    waitingLogin:
    ...
    setAiHint: 'Usa tu inicio de sesión de ; no se necesita clave de API.',
    ...
    setAiByokNote:
      'Los chats usan tu propia clave. La generación de imágenes y el análisis de medios siguen la sección «Medios de IA»; la búsqueda web sigue usando el inicio de sesión de  o fuentes gratuitas.',
    setAiSave: 'Guardar',
    setAiSaved: 'Guardado',
    ...
    setAiMediaHint:
      'La generación de imágenes y el análisis de imágenes/vídeos usan tu inicio de sesión de .',
    setAiImageModel: 'Modelo de imagen',
    setAiAnalysisModel: 'Modelo de análisis',
    setAiSearchHint:
      'La búsqueda web y de imágenes usa tu inicio de sesión de ; sin sesión o con las herramientas en la nube desactivadas recurre a fuentes gratuitas.',
    ...
    starPromptBody:
      'UToOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta UToOffice, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a UToOffice',
    ...
    onbBody2:
      'UToOffice aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de **',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de .',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย AI 助手 แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี  เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    login: 'ลงชื่อเข้าใช้ด้วย ',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedIn: 'ลงชื่อเข้าใช้  แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ  ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    setAiHint: 'ใช้การลงชื่อเข้าใช้  ไม่ต้องใช้คีย์ API',
    ...
    setAiByokNote:
      'การแชทใช้คีย์ของคุณเอง การสร้างภาพและการวิเคราะห์สื่อเป็นไปตามส่วน "สื่อ AI" ส่วนการค้นหาเว็บยังใช้การลงชื่อเข้าใช้  หรือแหล่งข้อมูลฟรี',
    setAiSave: 'บันทึก',
    ...
    setAiSearchHint:
      'การค้นหาเว็บและภาพใช้การลงชื่อเข้าใช้  หากไม่ได้ลงชื่อเข้าใช้หรือปิดเครื่องมือคลาวด์ จะใช้แหล่งข้อมูลฟรีแทน',
    ...
    starPromptBody:
      'UToOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ UToOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ UToOffice',
    ...
    onbBody2:
      'UToOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต  กว่า 1,000**',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต ',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan AI 助手. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun  untuk melihat proyek yang Anda buat di web.',
    ...
    setAiHint: 'Menggunakan login ; tanpa kunci API.',
    ...
    setAiByokNote:
      'Chat memakai kunci Anda sendiri. Pembuatan gambar dan analisis media mengikuti bagian "Media AI"; pencarian web tetap memakai login  atau sumber gratis.',
    setAiSave: 'Simpan',
    ...
    setAiSearchHint:
      'Pencarian web dan gambar memakai login  Anda; saat keluar atau alat cloud dimatikan, keduanya memakai sumber gratis.',
    ...
    starPromptBody:
      'UToOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai UToOffice, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di UToOffice',
    ...
    onbBody2:
      'UToOffice masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit **',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit .',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Проекты, созданные в вебе с AI 助手. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт , чтобы увидеть проекты, созданные в вебе.',
    ...
    loginNetworkError: 'Не удаётся подключиться к  — проверьте сеть или настройки прокси',
    ...
    setAiHint: 'Использует вход в ; ключ API не нужен.',
    ...
    setAiByokNote:
      'Чаты используют ваш собственный ключ. Генерация изображений и анализ медиа настраиваются в разделе «Медиа ИИ»; веб-поиск по-прежнему использует вход в  или бесплатные источники.',
    setAiSave: 'Сохранить',
    ...
    setAiSearchHint:
      'Веб-поиск и поиск изображений используют ваш вход в ; без входа или при выключенных облачных инструментах используются бесплатные источники.',
    ...
    starPromptBody:
      'UToOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится UToOffice, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в UToOffice',
    ...
    onbBody2:
      'UToOffice пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов **',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты .',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام AI 助手. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب  لعرض المشاريع التي أنشأتها على الويب.',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ  — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    setAiHint: 'يستخدم تسجيل الدخول إلى ؛ لا حاجة لمفتاح API.',
    ...
    setAiByokNote:
      'تستخدم المحادثات مفتاحك الخاص. يتبع توليد الصور وتحليل الوسائط قسم «وسائط الذكاء الاصطناعي»؛ ولا يزال البحث في الويب يستخدم تسجيل دخول  أو مصادر مجانية.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
    ...
    setAiMediaHint: 'يستخدم توليد الصور وتحليل الصور/الفيديو تسجيل دخولك إلى .',
    setAiImageModel: 'نموذج الصور',
    setAiAnalysisModel: 'نموذج التحليل',
    setAiSearchHint:
      'يستخدم البحث في الويب والصور تسجيل دخولك إلى ؛ وعند الخروج أو إيقاف الأدوات السحابية يعود إلى مصادر مجانية.',
    ...
    onbStarHint: 'إذا أعجبك UToOffice، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في UToOffice',
    ...
    onbBody2:
      'لا يزال UToOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة **',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة .',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Projetos criados na web com o AI 助手. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta  para ver os projetos criados na web.',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao  — verifique sua rede ou as configurações de proxy',
    ...
    setAiHint: 'Usa seu login ; nenhuma chave de API necessária.',
    ...
    setAiByokNote:
      'Os chats usam a sua própria chave. A geração de imagens e a análise de mídia seguem a seção «Mídia de IA»; a busca na web continua usando o login do  ou fontes gratuitas.',
    setAiSave: 'Salvar',
    setAiSaved: 'Salvo',
    ...
    setAiSearchHint:
      'A busca na web e de imagens usa o seu login do ; desconectado ou com as ferramentas na nuvem desativadas, recorre a fontes gratuitas.',
    ...
    starPromptBody:
      'O UToOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do UToOffice, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao UToOffice',
    ...
    onbBody2:
      'O UToOffice ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos **',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos .',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Progetti creati sul web con AI 助手. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account  per vedere i progetti creati sul web.',
    ...
    setAiHint: 'Usa il tuo accesso ; nessuna chiave API richiesta.',
    ...
    setAiByokNote:
      "Le chat usano la tua chiave. La generazione di immagini e l'analisi dei media seguono la sezione «Media IA»; la ricerca web usa ancora l'accesso  o fonti gratuite.",
    setAiSave: 'Salva',
    setAiSaved: 'Salvato',
    ...
    setAiMediaHint:
      "La generazione di immagini e l'analisi di immagini/video usano il tuo accesso .",
    setAiImageModel: 'Modello immagini',
    setAiAnalysisModel: 'Modello di analisi',
    setAiSearchHint:
      'La ricerca web e di immagini usa il tuo accesso ; disconnesso o con gli strumenti cloud disattivati ricorre a fonti gratuite.',
    ...
    starPromptBody:
      'UToOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace UToOffice, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in UToOffice',
    ...
    onbBody2:
      'UToOffice è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti **',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti .',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą AI 助手. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto , aby zobaczyć projekty utworzone w sieci.',
    ...
    account: 'Konto',
    login: 'Zaloguj się',
    login: 'Zaloguj się przez ',
    loggedIn: 'Zalogowano',
    loggedIn: 'Zalogowano do ',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z  — sprawdź sieć lub ustawienia proxy',
    ...
    setAiHint: 'Korzysta z logowania ; klucz API nie jest potrzebny.',
    ...
    setAiByokNote:
      'Czaty używają Twojego klucza. Generowanie obrazów i analiza mediów zależą od sekcji „Media AI”; wyszukiwanie w sieci nadal korzysta z logowania  lub darmowych źródeł.',
    setAiSave: 'Zapisz',
    setAiSaved: 'Zapisano',
    ...
    setAiSearchHint:
      'Wyszukiwanie w sieci i obrazów korzysta z logowania ; po wylogowaniu lub przy wyłączonych narzędziach chmurowych używa darmowych źródeł.',
    ...
    starPromptBody:
      'UToOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się UToOffice, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'UToOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów **',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty .',
    onbBack: 'Wstecz',
  },
  cs: {
    navRecent: 'Nedávné',
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Projekty vytvořené na webu pomocí AI 助手. Úpravy pokračují v prohlížeči — klikněte na projekt a otevřete ho.',
    ...
    cloudLoginHint:
      'Přihlaste se ke svému účtu  a zobrazte projekty, které jste vytvořili na webu.',
    ...
    account: 'Účet',
    login: 'Přihlásit se',
    login: 'Přihlásit se přes ',
    loggedIn: 'Přihlášeno',
    loggedIn: 'Přihlášeno ke ',
    waitingLogin:
    ...
    loginNetworkError: ' není dostupný — zkontrolujte síť nebo nastavení proxy',
    ...
    setAiHint: 'Používá vaše přihlášení ke ; klíč API není potřeba.',
    ...
    setAiByokNote:
      'Chaty používají váš vlastní klíč. Generování obrázků a analýza médií se řídí sekcí AI média; webové vyhledávání dál používá přihlášení ke  nebo bezplatné zdroje.',
    setAiSave: 'Uložit',
    setAiSaved: 'Uloženo',
    ...
    setAiSearchHint:
      'Webové a obrázkové vyhledávání používá vaše přihlášení ke ; při odhlášení nebo vypnutých cloudových nástrojích se použijí bezplatné zdroje.',
    ...
    starPromptBody:
      'UToOffice je zdarma a open source. Hvězdička na GitHubu je nejlepší způsob, jak tým podpořit.',
    starPromptGo: 'Dát hvězdičku na GitHubu',
    starPromptDone: 'Hvězdička už udělena',
    starPromptLater: 'Možná později',
    onbStarHint: 'Pokud se vám UToOffice líbí, dejte nám hvězdičku na GitHubu.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'UToOffice je stále ve fázi alfa. Připojte se ke skupinovému chatu na GenTeam, sdílejte zpětnou vazbu a pomozte utvářet, co přijde dál.',
    onbCredits: 'Aktivní přispěvatelé získají **1 000+ kreditů **',
    ...
    onbNote3: 'Funkce AI mohou čerpat kredity .',
    onbBack: 'Zpět',
  ...
  nl: {
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Projecten gemaakt op het web met AI 助手. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    loginNetworkError: 'Kan  niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    setAiHint: 'Gebruikt je -login; geen API-sleutel nodig.',
    ...
    setAiByokNote:
      'Chats gebruiken je eigen sleutel. Afbeeldingen genereren en media-analyse volgen de sectie "AI-media"; zoeken op het web gebruikt nog steeds de -aanmelding of gratis bronnen.',
    setAiSave: 'Opslaan',
    ...
    setAiSearchHint:
      'Web- en afbeeldingszoeken gebruiken je -aanmelding; afgemeld of met cloudtools uit vallen ze terug op gratis bronnen.',
    ...
    starPromptBody:
      'UToOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als UToOffice je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij UToOffice',
    ...
    onbBody2:
      'UToOffice is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ -credits**',
    ...
    onbNote3: 'AI-functies kunnen -credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'Projek yang dicipta di web dengan AI 助手. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun  untuk melihat projek yang anda cipta di web.',
    ...
    account: 'Akaun',
    login: 'Log masuk',
    login: 'Log masuk dengan ',
    loggedIn: 'Telah log masuk',
    loggedIn: 'Telah log masuk ke ',
    ...
    setAiHint: 'Menggunakan log masuk ; tiada kunci API diperlukan.',
    ...
    setAiByokNote:
      'Sembang menggunakan kunci anda sendiri. Penjanaan imej dan analisis media mengikut bahagian "Media AI"; carian web masih menggunakan log masuk  atau sumber percuma.',
    setAiSave: 'Simpan',
    setAiSaved: 'Disimpan',
    ...
    setAiAnalysisModel: 'Model analisis',
    setAiSearchHint:
      'Carian web dan imej menggunakan log masuk  anda; apabila log keluar atau alat awan dimatikan, ia menggunakan sumber percuma.',
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan UToOffice',
    starPromptBody:
      'UToOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka UToOffice, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke UToOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'UToOffice masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit **',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit .',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם AI 助手. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון  כדי לראות פרויקטים שיצרתם באתר.',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל- — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    setAiHint: 'משתמש בכניסת  שלך; אין צורך במפתח API.',
    ...
    setAiByokNote:
      'הצ׳אטים משתמשים במפתח שלך. יצירת תמונות וניתוח מדיה נקבעים בקטע "מדיה AI"; חיפוש באינטרנט עדיין משתמש בהתחברות  או במקורות חינמיים.',
    setAiSave: 'שמירה',
    setAiSaved: 'נשמר',
    ...
    setAiMediaHint: 'יצירת תמונות וניתוח תמונות/וידאו משתמשים בהתחברות  שלך.',
    setAiImageModel: 'מודל תמונות',
    setAiAnalysisModel: 'מודל ניתוח',
    setAiSearchHint:
      'חיפוש באינטרנט ובתמונות משתמש בהתחברות  שלך; כשלא מחוברים או כשכלי הענן כבויים הוא חוזר למקורות חינמיים.',
    ...
    onbStarHint: 'אם UToOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-UToOffice',
    ...
    onbBody2:
      'UToOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות **',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של .',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    navCloud: '云端项目',
    cloudSubtitle:
      'AI 助手 के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने  खाते में साइन इन करें।',
    ...
    account: 'खाता',
    login: 'साइन इन करें',
    login: ' से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedIn: ' में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: ' से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    setAiHint: 'आपके  साइन-इन का उपयोग करता है; API कुंजी की आवश्यकता नहीं।',
    ...
    setAiByokNote:
      'चैट आपकी अपनी कुंजी का उपयोग करती हैं। इमेज जनरेशन और मीडिया विश्लेषण "AI मीडिया" अनुभाग के अनुसार होते हैं; वेब खोज अभी भी  साइन-इन या मुफ़्त स्रोतों का उपयोग करती है।',
    setAiSave: 'सहेजें',
    ...
    setAiSearchHint:
      'वेब और इमेज खोज आपके  साइन-इन का उपयोग करती हैं; साइन-आउट होने पर या क्लाउड टूल बंद होने पर वे मुफ़्त स्रोतों पर लौट जाती हैं।',
    ...
    starPromptBody:
      'UToOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको UToOffice पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'UToOffice में आपका स्वागत है',
    ...
    onbBody2:
      'UToOffice अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+  क्रेडिट**',
    ...
    onbNote3: 'AI सुविधाएँ  क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: '云端项目',
    cloudSubtitle: '在網頁端用 AI 助手 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 ，請檢查網路或代理設定',
    ...
    setAiByokNote:
      '對話使用你自己的 key；生圖與媒體解析依「生圖與媒體」設定；網頁搜尋仍走  登入或免費來源。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
    ...
    onbStarHint: '如果你喜歡 UToOffice，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 UToOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'UToOffice 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+  點數**',
    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
