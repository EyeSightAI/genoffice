...
export const strings = {
  zh: {
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录账号，查看你在云端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    setAiGensparkHint: '登录账号后使用 AI，无需 API key。',
    setAiByokNote: '对话使用你自己的 key；网页搜索、生图等云工具需登录账号。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
    ...
    setAiGskTools: 'AI 云工具',
    setAiGskToolsDesc:
      '网页搜索、AI 生图、媒体分析经云端处理；关闭后生图与媒体分析不可用，搜索改用免费来源。',
    setGithub: '开源项目',
    ...
    membershipFree: '免费版',
    membershipPro: '会员版',
    membershipLifetime: '永久',
    membershipYear: '年卡',
    membershipExpiresAt: '有效期至 {date}',
    membershipActivate: '激活',
    membershipActivating: '激活中…',
    membershipBuy: '去购买',
    membershipPlaceholder: '输入卡密，如 UTO-XXXX-XXXX',
    membershipSuccess: '激活成功，会员功能已解锁',
    membershipInvalid: '卡密无效，请检查后重试',
    // Dates
    today: '今天',
    yesterday: '昨天',
    daysAgo: '{n}天前',
    ...
    onbSubtitle1: '你的 AI 原生办公套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'UToOffice 目前处于测试阶段。欢迎提交反馈，一起让它变得更好。',
    onbCredits: '感谢每一位反馈和贡献的用户',
    onbJoinGenTeam: '提交反馈',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
    ...
    onbNote3: 'AI 功能通过你自带的 API Key 使用，不产生额外费用。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    setAnalytics: 'Usage statistics',
    setAnalyticsDesc:
      'This app does not collect any usage data. Your documents and file names always stay on your device.',
    settings: 'Settings',
    ...
    setAiGensparkHint: 'Sign in to use AI; no API key needed.',
    setAiByokNote:
      'Chats use your own key; cloud tools (web search, image generation) still require signing in.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
    ...
    setAiGskTools: 'AI cloud tools',
    setAiGskToolsDesc:
      'Web search, AI image generation and media analysis run through the cloud; when off, image tools are unavailable and search uses free sources.',
    ...
    membershipYear: 'Yearly',
    membershipExpiresAt: 'Expires {date}',
    membershipActivate: 'Activate',
    membershipActivating: 'Activating…',
    membershipBuy: 'Buy',
    membershipPlaceholder: 'Enter card key, e.g. UTO-XXXX-XXXX',
    membershipSuccess: 'Activated — Pro features unlocked',
    membershipInvalid: 'Invalid card key, please check and retry',
    today: 'Today',
    yesterday: 'Yesterday',
    daysAgo: '{n}d ago',
    language: 'Language',
    ...
    onbSubtitle1: 'Your AI-native office suite',
    onbBody1:
      'Create docs, build sheets, make slides, and review PDFs. AI is built into every step.',
    onbTitle2: 'This is just the beginning',
    onbBody2:
      'UToOffice is still in beta. Send feedback and help shape what comes next.',
    onbCredits: 'Thanks to every contributor',
    onbJoinGenTeam: 'Send feedback',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features use your own API key at no extra cost.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
