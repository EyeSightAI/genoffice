...
export const strings = {
  zh: {
    ...
    setAiGskTools: '云工具',
    setAiGskToolsDesc:
      '网页搜索、AI 生图、媒体分析经  云端并消耗积分；关闭后生图与媒体分析不可用，搜索改用免费来源。',
    setGithub: '开源项目',
  ...
  en: {
    ...
    setAiByokNote:
      'Chats use your own key; cloud tools (web search, image generation) still require the  sign-in.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
    ...
    setAiGskToolsDesc:
      'Web search, AI image generation and media analysis run through  and use credits; when off, image tools are unavailable and search uses free sources.',
  ...
  ja: {
    ...
    setAiByokNote:
      'チャットは自分のキーを使用します。ウェブ検索や画像生成などのクラウドツールには  へのサインインが必要です。',
    setAiSave: '保存',
    setAiSaved: '保存しました',
    setAiTest: '接続テスト',
    setAiTesting: 'テスト中…',
    ...
    setAiGskToolsDesc:
      'ウェブ検索・AI 画像生成・メディア分析は  クラウド経由でクレジットを消費します。オフにすると画像ツールは使えず、検索は無料ソースを使用します。',
    setGithub: 'オープンソース',
  ...
  ko: {
    ...
    setAiGskToolsDesc:
      '웹 검색·AI 이미지 생성·미디어 분석은  클라우드를 거치며 크레딧을 사용합니다. 끄면 이미지 도구를 사용할 수 없고 검색은 무료 소스를 사용합니다.',
    setGithub: '오픈 소스',
  ...
  fr: {
    ...
    setAiByokNote:
      "Les conversations utilisent votre propre clé ; les outils cloud (recherche web, génération d'images) nécessitent toujours la connexion .",
    ...
    setAiGskToolsDesc:
      "Recherche web, génération d'images et analyse de médias passent par  et consomment des crédits ; désactivé, les outils d'image sont indisponibles et la recherche utilise des sources gratuites.",
    setGithub: 'Open source',
  ...
  de: {
    ...
    setAiByokNote:
      'Chats verwenden Ihren eigenen Schlüssel; Cloud-Tools (Websuche, Bilderzeugung) erfordern weiterhin die -Anmeldung.',
    setAiSave: 'Speichern',
    ...
    setAiGskTools: '-Cloud-Tools',
    setAiGskToolsDesc:
      'Websuche, KI-Bilderzeugung und Medienanalyse laufen über  und verbrauchen Guthaben; ausgeschaltet sind Bildtools nicht verfügbar und die Suche nutzt freie Quellen.',
    setGithub: 'Open Source',
  ...
  es: {
    ...
    setAiByokNote:
      'Los chats usan tu propia clave; las herramientas en la nube (búsqueda web, generación de imágenes) siguen requiriendo el inicio de sesión de .',
    setAiSave: 'Guardar',
    setAiSaved: 'Guardado',
    ...
    setAiGskToolsDesc:
      'La búsqueda web, la generación de imágenes y el análisis de medios pasan por  y consumen créditos; desactivado, las herramientas de imagen no están disponibles y la búsqueda usa fuentes gratuitas.',
  ...
  th: {
    ...
    setAiGskToolsDesc:
      'ค้นเว็บ สร้างภาพ AI และวิเคราะห์สื่อผ่านคลาวด์  และใช้เครดิต ปิดแล้วเครื่องมือภาพจะใช้ไม่ได้ และการค้นหาใช้แหล่งฟรี',
  ...
  id: {
    ...
    setAiByokNote:
      'Obrolan memakai kunci Anda sendiri; alat cloud (pencarian web, pembuatan gambar) tetap memerlukan login .',
    setAiSave: 'Simpan',
    ...
    setAiGskToolsDesc:
      'Pencarian web, pembuatan gambar AI, dan analisis media berjalan lewat  dan memakai kredit; jika dimatikan, alat gambar tidak tersedia dan pencarian memakai sumber gratis.',
  ...
  ru: {
    ...
    setAiByokNote:
      'Чаты используют ваш собственный ключ; облачные инструменты (веб-поиск, генерация изображений) по-прежнему требуют входа в .',
    setAiSave: 'Сохранить',
    ...
    setAiGskToolsDesc:
      'Веб-поиск, генерация изображений и анализ медиа идут через  и расходуют кредиты; при отключении инструменты изображений недоступны, а поиск использует бесплатные источники.',
  ...
  ar: {
    ...
    setAiByokNote:
      'تستخدم المحادثات مفتاحك الخاص؛ أدوات السحابة (بحث الويب وتوليد الصور) ما زالت تتطلب تسجيل الدخول إلى .',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
    ...
    setAiGskToolsDesc:
      'يمر بحث الويب وتوليد الصور وتحليل الوسائط عبر سحابة  ويستهلك الرصيد؛ عند الإيقاف تصبح أدوات الصور غير متاحة ويستخدم البحث مصادر مجانية.',
  ...
  pt: {
    ...
    setAiByokNote:
      'Os chats usam sua própria chave; as ferramentas na nuvem (busca na web, geração de imagens) ainda exigem o login .',
    setAiSave: 'Salvar',
    setAiSaved: 'Salvo',
    ...
    setAiGskToolsDesc:
      'Busca na web, geração de imagens e análise de mídia passam pela  e consomem créditos; desligado, as ferramentas de imagem ficam indisponíveis e a busca usa fontes gratuitas.',
  ...
  it: {
    ...
    setAiByokNote:
      "Le chat usano la tua chiave; gli strumenti cloud (ricerca web, generazione immagini) richiedono comunque l'accesso .",
    setAiSave: 'Salva',
    setAiSaved: 'Salvato',
    ...
    setAiGskToolsDesc:
      'Ricerca web, generazione di immagini e analisi dei media passano da  e consumano crediti; se disattivato, gli strumenti immagine non sono disponibili e la ricerca usa fonti gratuite.',
    setGithub: 'Open source',
  ...
  pl: {
    ...
    setAiByokNote:
      'Czaty używają Twojego klucza; narzędzia w chmurze (wyszukiwanie, generowanie obrazów) nadal wymagają logowania .',
    setAiSave: 'Zapisz',
    setAiSaved: 'Zapisano',
    ...
    setAiGskToolsDesc:
      'Wyszukiwanie w sieci, generowanie obrazów AI i analiza mediów przechodzą przez  i zużywają kredyty; po wyłączeniu narzędzia obrazów są niedostępne, a wyszukiwanie korzysta z darmowych źródeł.',
    setGithub: 'Open source',
  ...
  nl: {
    ...
    setAiByokNote:
      'Chats gebruiken je eigen sleutel; cloudtools (webzoeken, beeldgeneratie) vereisen nog steeds de -login.',
    setAiSave: 'Opslaan',
    ...
    setAiGskToolsDesc:
      'Webzoeken, AI-beeldgeneratie en media-analyse lopen via  en verbruiken tegoed; uitgeschakeld zijn beeldtools niet beschikbaar en gebruikt zoeken gratis bronnen.',
    setGithub: 'Open source',
  ...
  ms: {
    ...
    setAiByokNote:
      'Sembang menggunakan kunci anda sendiri; alat awan (carian web, penjanaan imej) masih memerlukan log masuk .',
    setAiSave: 'Simpan',
    setAiSaved: 'Disimpan',
    ...
    setAiGskToolsDesc:
      'Carian web, penjanaan imej AI dan analisis media melalui awan  dan menggunakan kredit; jika dimatikan, alat imej tidak tersedia dan carian menggunakan sumber percuma.',
    setGithub: 'Sumber Terbuka',
    starOnGitHub: 'Beri Bintang di GitHub',
    starPromptTitle: 'Suka UToOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan UToOffice',
  ...
  he: {
    ...
    setAiByokNote:
      'שיחות משתמשות במפתח שלך; כלי ענן (חיפוש ברשת, יצירת תמונות) עדיין דורשים כניסת .',
    setAiSave: 'שמירה',
    setAiSaved: 'נשמר',
    ...
    setAiGskTools: 'כלי הענן',
    setAiGskToolsDesc:
      'חיפוש ברשת, יצירת תמונות וניתוח מדיה עוברים דרך  וצורכים קרדיטים; בכיבוי, כלי התמונות אינם זמינים והחיפוש משתמש במקורות חינמיים.',
    setGithub: 'קוד פתוח',
  ...
  hi: {
    ...
    setAiByokNote:
      'चैट आपकी अपनी कुंजी का उपयोग करती हैं; क्लाउड टूल (वेब खोज, छवि निर्माण) के लिए अभी भी  साइन-इन आवश्यक है।',
    setAiSave: 'सहेजें',
    ...
    setAiGskToolsDesc:
      'वेब खोज, AI छवि निर्माण और मीडिया विश्लेषण  क्लाउड से होते हैं और क्रेडिट खर्च करते हैं; बंद करने पर छवि टूल अनुपलब्ध होंगे और खोज मुफ्त स्रोतों का उपयोग करेगी।',
    setGithub: 'ओपन सोर्स',
  ...
  'zh-TW': {
    ...
    setAiGskTools: ' 雲端工具',
    setAiGskToolsDesc:
      '網頁搜尋、AI 生圖、媒體分析經  雲端並消耗點數；關閉後生圖與媒體分析不可用，搜尋改用免費來源。',
    setGithub: '開源專案',
