...
const tMain = createI18n({
  zh: {
    ...
    btnCancel: '取消',
    pdfDocxFailedMsg: '导出为 Word 失败',    pdfDocxBusyMsg: '正在转换中，请等待当前导出完成。',
  ...
  en: {
    ...
    btnCancel: 'Cancel',
    pdfDocxFailedMsg: 'Export as Word failed',    pdfDocxBusyMsg: 'A Word export is already in progress. Please wait for it to finish.',
  ...
  ja: {
    ...
    btnCancel: 'キャンセル',
    pdfDocxFailedMsg: 'Word への書き出しに失敗しました',    pdfDocxBusyMsg: 'Word への書き出しが進行中です。完了までお待ちください。',
  ...
  ko: {
    ...
    btnCancel: '취소',
    pdfDocxFailedMsg: 'Word로 내보내기 실패',    pdfDocxBusyMsg: 'Word 내보내기가 이미 진행 중입니다. 완료될 때까지 기다려 주세요.',
  ...
  fr: {
    ...
    btnCancel: 'Annuler',
    pdfDocxFailedMsg: "Échec de l'export en Word",    pdfDocxBusyMsg: "Un export en Word est déjà en cours. Veuillez attendre qu'il se termine.",
  ...
  de: {
    ...
    btnCancel: 'Abbrechen',
    pdfDocxFailedMsg: 'Word-Export fehlgeschlagen',    pdfDocxBusyMsg: 'Ein Word-Export läuft bereits. Bitte warten Sie, bis er abgeschlossen ist.',
  ...
  es: {
    ...
    btnCancel: 'Cancelar',
    pdfDocxFailedMsg: 'Error al exportar como Word',    pdfDocxBusyMsg: 'Ya hay una exportación a Word en curso. Espera a que termine.',
  ...
  th: {
    ...
    btnCancel: 'ยกเลิก',
    pdfDocxFailedMsg: 'ส่งออกเป็น Word ไม่สำเร็จ',    pdfDocxBusyMsg: 'กำลังส่งออกเป็น Word อยู่ โปรดรอให้เสร็จสิ้นก่อน',
  ...
  id: {
    ...
    btnCancel: 'Batal',
    pdfDocxFailedMsg: 'Gagal mengekspor sebagai Word',    pdfDocxBusyMsg: 'Ekspor ke Word sedang berlangsung. Harap tunggu hingga selesai.',
  ...
  ru: {
    ...
    btnCancel: 'Отмена',
    pdfDocxFailedMsg: 'Не удалось экспортировать в Word',    pdfDocxBusyMsg: 'Экспорт в Word уже выполняется. Дождитесь его завершения.',
  ...
  ar: {
    ...
    btnCancel: 'إلغاء',
    pdfDocxFailedMsg: 'فشل التصدير كملف Word',    pdfDocxBusyMsg: 'يجري حاليًا تصدير إلى Word. يُرجى الانتظار حتى يكتمل.',
  ...
  pt: {
    ...
    menuExportDocx: 'Exportar como Word…',
    btnCancel: 'Cancelar',
    pdfDocxFailedMsg: 'Falha ao exportar como Word',    pdfDocxBusyMsg: 'Já há uma exportação para Word em andamento. Aguarde a conclusão.',
    menuExportPptx: 'Exportar como PowerPoint…',
  ...
  it: {
    ...
    btnCancel: 'Annulla',
    pdfDocxFailedMsg: 'Esportazione in Word non riuscita',    pdfDocxBusyMsg: "Un'esportazione in Word è già in corso. Attendi il completamento.",
  ...
  pl: {
    ...
    btnCancel: 'Anuluj',
    pdfDocxFailedMsg: 'Eksport do formatu Word nie powiódł się',    pdfDocxBusyMsg: 'Eksport do formatu Word już trwa. Poczekaj na jego zakończenie.',
  ...
  nl: {
    ...
    btnCancel: 'Annuleren',
    pdfDocxFailedMsg: 'Exporteren als Word mislukt',    pdfDocxBusyMsg: 'Er is al een Word-export bezig. Wacht tot deze is voltooid.',
  ...
  ms: {
    ...
    btnCancel: 'Batal',
    pdfDocxFailedMsg: 'Gagal mengeksport sebagai Word',    pdfDocxBusyMsg: 'Eksport ke Word sedang dijalankan. Sila tunggu sehingga selesai.',
  ...
  he: {
    ...
    btnCancel: 'ביטול',
    pdfDocxFailedMsg: 'הייצוא כ-Word נכשל',    pdfDocxBusyMsg: 'ייצוא ל-Word כבר מתבצע. נא להמתין לסיומו.',
  ...
  hi: {
    ...
    btnCancel: 'रद्द करें',
    pdfDocxFailedMsg: 'Word के रूप में निर्यात विफल रहा',    pdfDocxBusyMsg: 'Word के रूप में निर्यात पहले से चल रहा है। कृपया पूरा होने तक प्रतीक्षा करें।',
  ...
  'zh-TW': {
    ...
    btnCancel: '取消',
    pdfDocxFailedMsg: '匯出為 Word 失敗',    pdfDocxBusyMsg: '正在轉換中，請等待目前的匯出完成。',
...
function createShellWindow(): void {
  const win = new BrowserWindow({
    ...
    minWidth: 720,
    minHeight: 550,
    title: 'UToOffice',    // vibrancy: editor modules punch translucent regions (e.g. the slides
