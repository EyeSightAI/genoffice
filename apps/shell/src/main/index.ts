...
const tMain = createI18n({
  zh: {
    ...
    pdfDocxBtnLogin: '登录',
    pdfDocxConfirmMsg: '将此 PDF 上传到  云端转换为 Word？',
  ...
  en: {
    ...
    pdfDocxLoginMsg: 'Exporting as Word requires signing in to .',
    pdfDocxLoginDetail:
      'Clicking “Sign In” opens your browser to authorize; once done, click Export again.',
    pdfDocxBtnLogin: 'Sign In',
    pdfDocxConfirmMsg: 'Upload this PDF to  cloud and convert it to Word?',
    ...
    pdfDocxNoCliMsg:
      'Cannot sign in to : a required component (gsk) is missing. Please reinstall the app.',
  ...
  ja: {
    ...
    pdfDocxLoginMsg: 'Word への書き出しには  へのログインが必要です。',
    pdfDocxLoginDetail:
      '「ログイン」をクリックするとブラウザで認証します。完了後、もう一度書き出しを実行してください。',
    pdfDocxBtnLogin: 'ログイン',
    pdfDocxConfirmMsg: 'この PDF を  クラウドにアップロードして Word に変換しますか？',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      ' にサインインできません：必要なコンポーネント（gsk）が見つかりません。アプリを再インストールしてください。',
  ...
  ko: {
    ...
    pdfDocxLoginMsg: 'Word로 내보내려면  로그인이 필요합니다.',
    pdfDocxLoginDetail:
      '“로그인”을 클릭하면 브라우저에서 인증합니다. 완료 후 내보내기를 다시 클릭하세요.',
    pdfDocxBtnLogin: '로그인',
    pdfDocxConfirmMsg: '이 PDF를  클라우드에 업로드하여 Word로 변환할까요?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      '에 로그인할 수 없습니다. 필수 구성 요소(gsk)가 없습니다. 앱을 다시 설치해 주세요.',
  ...
  fr: {
    ...
    pdfDocxLoginMsg: "L'export en Word nécessite une connexion à .",
    pdfDocxLoginDetail:
      "Cliquez sur « Se connecter » pour autoriser dans le navigateur, puis relancez l'export.",
    pdfDocxBtnLogin: 'Se connecter',
    pdfDocxConfirmMsg: 'Téléverser ce PDF vers le cloud  pour le convertir en Word ?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      "Connexion à  impossible : un composant requis (gsk) est manquant. Veuillez réinstaller l'application.",
  ...
  de: {
    ...
    pdfDocxLoginMsg: 'Für den Word-Export ist eine Anmeldung bei  erforderlich.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: 'Dieses PDF in die -Cloud hochladen und in Word konvertieren?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Anmeldung bei  nicht möglich: Eine erforderliche Komponente (gsk) fehlt. Bitte installieren Sie die App neu.',
  ...
  es: {
    ...
    pdfDocxLoginMsg: 'Para exportar como Word es necesario iniciar sesión en .',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: '¿Subir este PDF a la nube de  para convertirlo a Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'No se puede iniciar sesión en : falta un componente necesario (gsk). Reinstale la aplicación.',
  ...
  th: {
    ...
    pdfDocxLoginMsg: 'การส่งออกเป็น Word ต้องเข้าสู่ระบบ ',
    pdfDocxLoginDetail:
      'คลิก “เข้าสู่ระบบ” เพื่อเปิดเบราว์เซอร์ยืนยันตัวตน เสร็จแล้วให้คลิกส่งออกอีกครั้ง',
    pdfDocxBtnLogin: 'เข้าสู่ระบบ',
    pdfDocxConfirmMsg: 'อัปโหลด PDF นี้ไปยังคลาวด์  เพื่อแปลงเป็น Word หรือไม่?',
    ...
    pdfDocxNoCliMsg:
      'ไม่สามารถลงชื่อเข้าใช้  ได้: ไม่พบคอมโพเนนต์ที่จำเป็น (gsk) โปรดติดตั้งแอปใหม่',
  ...
  id: {
    ...
    pdfDocxLoginMsg: 'Ekspor sebagai Word memerlukan login ke .',
    pdfDocxLoginDetail:
      'Klik “Masuk” untuk membuka browser dan memberi otorisasi; setelah selesai, klik Ekspor lagi.',
    pdfDocxBtnLogin: 'Masuk',
    pdfDocxConfirmMsg: 'Unggah PDF ini ke cloud  untuk dikonversi ke Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Tidak dapat masuk ke : komponen yang diperlukan (gsk) tidak ditemukan. Silakan instal ulang aplikasi.',
  ...
  ru: {
    ...
    pdfDocxLoginMsg: 'Для экспорта в Word требуется вход в .',
    pdfDocxLoginDetail:
      'Нажмите «Войти», чтобы авторизоваться в браузере, затем снова запустите экспорт.',
    pdfDocxBtnLogin: 'Войти',
    pdfDocxConfirmMsg: 'Загрузить этот PDF в облако  и конвертировать в Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Не удаётся войти в : отсутствует необходимый компонент (gsk). Переустановите приложение.',
  ...
  ar: {
    ...
    pdfDocxLoginMsg: 'يتطلب التصدير كملف Word تسجيل الدخول إلى .',
    pdfDocxLoginDetail:
      'انقر على «تسجيل الدخول» لفتح المتصفح وإتمام التفويض، ثم انقر على التصدير مرة أخرى.',
    pdfDocxBtnLogin: 'تسجيل الدخول',
    pdfDocxConfirmMsg: 'رفع هذا الـ PDF إلى سحابة  وتحويله إلى Word؟',
    ...
    pdfDocxNoCliMsg:
      'تعذّر تسجيل الدخول إلى : المكوّن المطلوب (gsk) مفقود. يُرجى إعادة تثبيت التطبيق.',
  ...
  pt: {
    ...
    menuExportDocx: 'Exportar como Word…',
    pdfDocxLoginMsg: 'Exportar como Word requer login no .',
    pdfDocxLoginDetail:
      'Clique em “Entrar” para autorizar no navegador; depois, clique em Exportar novamente.',
    pdfDocxBtnLogin: 'Entrar',
    pdfDocxConfirmMsg: 'Enviar este PDF para a nuvem do  e convertê-lo em Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Não é possível iniciar sessão no : falta um componente necessário (gsk). Reinstale o aplicativo.',
  ...
  it: {
    ...
    pdfDocxLoginMsg: 'Per esportare come Word è necessario accedere a .',
    pdfDocxLoginDetail:
      'Fai clic su “Accedi” per autorizzare nel browser; al termine, fai di nuovo clic su Esporta.',
    pdfDocxBtnLogin: 'Accedi',
    pdfDocxConfirmMsg: 'Caricare questo PDF sul cloud  e convertirlo in Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      "Impossibile accedere a : manca un componente necessario (gsk). Reinstallare l'app.",
  ...
  pl: {
    ...
    pdfDocxLoginMsg: 'Eksport do formatu Word wymaga zalogowania do .',
    pdfDocxLoginDetail:
      'Kliknij „Zaloguj się”, aby autoryzować w przeglądarce; po zakończeniu kliknij Eksportuj ponownie.',
    pdfDocxBtnLogin: 'Zaloguj się',
    pdfDocxConfirmMsg: 'Przesłać ten PDF do chmury  i przekonwertować na Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Nie można zalogować się do : brakuje wymaganego komponentu (gsk). Zainstaluj aplikację ponownie.',
  ...
  nl: {
    ...
    pdfDocxLoginMsg: 'Exporteren als Word vereist inloggen bij .',
    pdfDocxLoginDetail:
      'Klik op “Inloggen” om in de browser te autoriseren; klik daarna opnieuw op Exporteren.',
    pdfDocxBtnLogin: 'Inloggen',
    pdfDocxConfirmMsg: 'Deze PDF uploaden naar de -cloud en converteren naar Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Kan niet inloggen bij : een vereist onderdeel (gsk) ontbreekt. Installeer de app opnieuw.',
  ...
  ms: {
    ...
    pdfDocxLoginMsg: 'Eksport sebagai Word memerlukan log masuk ke .',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: 'Muat naik PDF ini ke awan  untuk ditukar kepada Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Tidak dapat log masuk ke : komponen yang diperlukan (gsk) tiada. Sila pasang semula aplikasi.',
  ...
  he: {
    ...
    pdfDocxNoCliMsg: 'לא ניתן להתחבר ל-: רכיב נדרש (gsk) חסר. נא להתקין מחדש את האפליקציה.',
  ...
  hi: {
    ...
    pdfDocxLoginMsg: 'Word के रूप में निर्यात करने के लिए  में लॉगिन आवश्यक है।',
    pdfDocxLoginDetail:
      '“लॉगिन” पर क्लिक करने से ब्राउज़र में प्राधिकरण खुलेगा; पूरा होने पर फिर से निर्यात पर क्लिक करें।',
    pdfDocxBtnLogin: 'लॉगिन',
    pdfDocxConfirmMsg: 'इस PDF को  क्लाउड पर अपलोड करके Word में बदलें?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      ' में साइन इन नहीं किया जा सकता: आवश्यक घटक (gsk) मौजूद नहीं है। कृपया ऐप को फिर से इंस्टॉल करें।',
  ...
  'zh-TW': {
    ...
    pdfDocxLoginMsg: '匯出為 Word 需要登入  帳號。',
    pdfDocxLoginDetail: '點擊「登入」將開啟瀏覽器完成授權，完成後請重新點擊匯出。',
    pdfDocxBtnLogin: '登入',
    pdfDocxConfirmMsg: '將此 PDF 上傳到  雲端轉換為 Word？',
    ...
    pdfDocxNoCliMsg: '無法登入 ：缺少必要元件（gsk），請重新安裝應用程式。',
