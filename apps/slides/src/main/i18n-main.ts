/** Main-process i18n strings for UToOffice Slides (dialogs, native menus, export, autosave prompts). */
...
export const tMain = createI18n({
  ...
  ja: {
    ...
    errGskCli:
      'gsk が未サインインです。先に gsk login を実行して  アカウントにサインインしてください',
    errNoDeckAppend:
  ...
  de: {
    ...
    errGskCli:
      'gsk nicht angemeldet: Führen Sie zuerst gsk login aus, um sich bei Ihrem -Konto anzumelden',
    errNoDeckAppend:
  ...
  es: {
    ...
    errGskCli:
      'gsk sin sesión iniciada: ejecuta primero gsk login para iniciar sesión en tu cuenta de ',
    errNoDeckAppend:
  ...
  it: {
    ...
    errGskCli:
      "gsk non ha effettuato l'accesso: esegui prima gsk login per accedere al tuo account ",
    errNoDeckAppend:
